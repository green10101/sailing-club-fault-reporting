                ...
                <?php foreach ($reports as $report): ?>
                    <tr>
                        ...
                        <td class="fault-description-cell">
                            ...
                            <?php endif; ?>
                            <span class="fault-description-text"><?php echo htmlspecialchars($report['fault_description']); ?></span>
                        </td>
                        ...
                        <td class="bosun-notes-cell"><span class="bosun-notes-text"><?php echo htmlspecialchars($report['bosun_notes'] ?? ''); ?></span></td>
