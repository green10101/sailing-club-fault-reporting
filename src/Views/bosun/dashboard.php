                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if (isset($_SESSION['user']['role']) && $_SESSION['user']['role'] === 'admin'): ?>
                                <button onclick="if(confirm('Are you sure you want to delete this fault report? This action cannot be undone.')) { window.location.href='index.php?route=/admin/delete-report/<?php echo $report['id']; ?>'; }" class="btn btn-sm btn-outline-danger" title="Delete Report" style="margin-left: 0.25rem;">
                                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
